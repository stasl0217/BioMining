...
def extract_concept(typeID, ccptmention_dict, FSArrays, concepts, sentence_list, paragraph_breaks):
    """
    ...
    try:
        ...
        # type_id = int(ccptmention_dict['typeID'])-1  # document: 1~6 code:0~5
        type_id=typeID  # use type system in code, not in document's typeID or UMLS's TUI
        ...
        for child in root:
            ...
            for typeID in range(0, _N):
                if tag == _types[typeID]:
                    ...
                    mention = extract_concept(typeID, attributes, FSArrays, umls_concepts,
